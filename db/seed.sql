...
INSERT OR IGNORE INTO links (token, destination, description, active) VALUES
...
INSERT INTO clicks (
    token, link_id, clicked_at, ip, ip_asn, ip_org, ip_country,
...
(
    ...
    0, '', 90, 'human', 'browser_headers, accept_html, sec_fetch_present', 1, 0
),
...
(
    ...
    '198.51.100.25', '64501', 'Example Cable Provider', 'US', 'visitor_demo_2',
    'GET', 'yourdomain.example', 'https', '/invoice', '', 50211,
    'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)',
    '', 'text/html', 'en-US,en;q=0.9', 'gzip',
    0, '', 30, 'suspicious', 'accept_html, minimal_headers', 1, 0
),
...
(
    ...
    '192.0.2.50', '64502', 'Example Hosting Provider', 'FR', 'visitor_bot_1',
    'POST', 'yourdomain.example', 'http', '/hello.world', 'allow_url_include=1', 60178,
    'libredtail-http', '', '*/*', '', '',
    1, 'suspicious_query, non_browser_ua', 0, 'bot', 'ua:libredtail, exploit_pattern', 1, 0
),

-- Scanner noise — no token (unknown path probe)
(
    '.env',
    NULL,
    ...
    '', '', '*/*', '', '',
    1, 'scanner', 0, 'bot', 'common_probe', 1, 0
);
